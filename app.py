...
# Hardcoding the FAL API Key:
fal_api_key = "e8efb1d2-1537-4bc5-996d-78b75a08aab2:c98b25ab01dff2d68257130e6d1b643a" # DO NOT COMMIT THIS TO PUBLIC REPOS
...
if st.button("Generate Podcast"):
    with st.spinner("Generating..."):
        if not openrouter_api_key:  # Only checking OpenRouter Key since FAL is hardcoded
